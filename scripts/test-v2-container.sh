...
GMAIL_CLIENT_ID="${FLYMAIL_SMOKE_GMAIL_CLIENT_ID:-smoke-gmail-client}"
GMAIL_CLIENT_SECRET="${FLYMAIL_SMOKE_GMAIL_CLIENT_SECRET:-Gmail-$(openssl rand -hex 24)}"
OUTLOOK_CLIENT_ID="${FLYMAIL_SMOKE_OUTLOOK_CLIENT_ID:-smoke-outlook-client}"
OUTLOOK_CLIENT_SECRET="${FLYMAIL_SMOKE_OUTLOOK_CLIENT_SECRET:-Outlook-$(openssl rand -hex 24)}"
