...
- 使用当前仓库源码构建 `benxianyu/flymail:0.0.39` 单容器镜像
...
```bash
docker build -t benxianyu/flymail:0.0.39 .
```
...
```bash
docker push benxianyu/flymail:0.0.39
```
