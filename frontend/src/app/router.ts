...
export const routeRecords: RouteRecordRaw[] = [
  ...
  { path: '/accounts', name: 'accounts', component: () => import('../features/accounts/AccountsPage.vue') },
  { path: '/contacts', name: 'contacts', component: () => import('../features/contacts/ContactsPage.vue') },
  { path: '/notifications', name: 'notifications', component: () => import('../features/notifications/NotificationCenter.vue') },
  { path: '/notification-settings', name: 'notification-settings', component: () => import('../features/notifications/NotificationSettingsPage.vue') },
  { path: '/oauth/callback', name: 'oauth-callback', component: () => import('../features/accounts/OAuthCallbackPage.vue') },
